...
const qnaList = [
  ...
  {
    id: 2,
    question: 'Q. 어떤 방식으로 일하는 것을 중요하게 생각하나요?',
    answer: (
      <>
        ...
        <br />
        또한 화면을 구현할 때는 단순 디자인을 구현 외에도 이후 <strong>기능 확장이나 유지보수를 고려해 구조화</strong>하려고 합니다.<br />
  ...
  },
  {
    ...
    answer: (
      <>
        <strong>구조와 데이터 흐름을 이해하고 안정적으로 확장할 수 있는 개발자</strong>로 나아가고자 합니다.<br />
        React 기반 리뉴얼 프로젝트를 진행하며 컴포넌트 단위로 역할을 분리하고 재사용성을 고려한 구조를 고민해왔으며<br />
        API 통신과 상태 관리를 직접 구현하며 프론트엔드 영역을 확장해왔습니다.<br />
        <br />
        화면의 완성도 이외에도 성능, 유지보수성, 데이터 흐름까지 균형 있게 고려할 수 있는 개발자로 자리 잡는 것이 목표입니다.
      </>
    )
  }
];
